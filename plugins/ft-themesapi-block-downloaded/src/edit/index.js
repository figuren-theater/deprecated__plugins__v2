...
export default function edit( {
	...
	const metaFieldValue = Number(meta[ 'downloaded' ]).toLocaleString('de-DE');
	const updateMetaValue = ( newValue ) => {
		setMeta( { ...meta, downloaded: newValue } );
	};
	...
	return (
		<>
			...
			<RichText
				...
				placeholder={ __( 'downloaded', 'ft-themesapi-block-downloaded' ) }
			/>
		</>
	);
}

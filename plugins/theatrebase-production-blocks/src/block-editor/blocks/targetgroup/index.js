...
registerBlockType(name, {
	...settings,
	title: _x('Targetgroup','block title','theatrebase-production-blocks'),
	description: _x('Shows targetgroup of current production.','block description','theatrebase-production-blocks'),

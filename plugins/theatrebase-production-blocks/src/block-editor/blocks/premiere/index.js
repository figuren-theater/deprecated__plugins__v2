...
registerBlockType(name, {
	...settings,
	title: _x('Premiere','block title','theatrebase-production-blocks'),
	description: _x('Show Premiere Date of production.','block description','theatrebase-production-blocks'),

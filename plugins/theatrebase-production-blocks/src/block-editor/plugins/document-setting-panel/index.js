...
const ProductionDocumentSettingPanel = () => {
	...
	return (
		<PluginDocumentSettingPanel
			...
			icon="art"
			title={ __( 'Production Meta', 'theatrebase-production-blocks' ) }
			className="t7b4-production-document-setting-panel"
		>
			<div className="plugin-sidebar-content">
				<RichText
					tagName="p"
					value={ __( 'Premiere Date', 'theatrebase-production-blocks' ) }
				/>
				<DateSelect
				...
				<TextControl
					label={ __( 'Targetgroup', 'theatrebase-production-blocks' ) }
				...
				<NumberControl
					label={ __( 'Duration', 'theatrebase-production-blocks' ) }
					isShiftStepEnabled
					shiftStep="5"
					step="5"
					min={ 0 }
				...
				<RichText
					tagName="p"
					className="howto"
					value={ __( 'Add the duration in Minutes.', 'theatrebase-production-blocks' ) }
				/>
			</div>
